...
namespace FUIEditor
{
    ...
    public static class FUICodeSpawner
    {
        ...
        // 代码生成路径
        public const string FUIAutoGenDir = "../Unity/Assets/Scripts/ModelView/Client/FUIAutoGen";
        public const string ModelViewCodeDir = "../Unity/Assets/Scripts/ModelView/Client/FUI";
        public const string HotfixViewCodeDir = "../Unity/Assets/Scripts/HotfixView/Client/FUI";
        ...
        private static void ParseAllPackages()
        {
            ...
            string fuiAssetsDir = Application.dataPath + "/../../FairyGUI/assets";
