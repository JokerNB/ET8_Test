namespace ET.Client
{
    ...
    {
        // 场景切换协程
        public static async ETTask SceneChangeTo(Scene root, string sceneName, long sceneInstanceId, int mapConfigId)
        {
            ...
            EventSystem.Instance.Publish(root, new SceneChangeStart(){mapConfigId = mapConfigId});
            // 等待CreateMyUnit的消息
